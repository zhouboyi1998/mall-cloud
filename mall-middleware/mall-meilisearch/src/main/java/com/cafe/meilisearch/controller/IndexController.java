...
public class IndexController {
    ...
    public ResponseEntity<TaskInfo> create(@PathVariable(value = "uid") String uid) {
        TaskInfo taskInfo = indexService.create(uid);
        return ResponseEntity.ok(taskInfo);
    }

    @ApiLogPrint(value = "修改索引的私钥")
    @ApiOperation(value = "修改索引的私钥")
    @ApiImplicitParams(value = {
        @ApiImplicitParam(value = "索引uid", name = "uid", dataType = "String", paramType = "path", required = true),
        @ApiImplicitParam(value = "索引的私钥", name = "primaryKey", dataType = "String", paramType = "query")
    })
