...
public class AddressController {
    ...
    @ApiLogPrint(value = "根据条件查询查询收货地址数量")
    ...
    @ApiLogPrint(value = "根据条件查询收货地址列表")
    ...
    @ApiLogPrint(value = "根据条件分页查询收货地址")
    ...
    @ApiLogPrint(value = "根据id查询单个收货地址")
    ...
    @ApiLogPrint(value = "根据条件查询单个收货地址")
    ...
    @ApiLogPrint(value = "根据ids批量修改收货地址")
    ...
    @ApiLogPrint(value = "根据ids批量删除收货地址")
    ...
    @ApiLogPrint(value = "根据条件批量删除收货地址")
