...
public class SaleServiceController {
    ...
    @ApiLogPrint(value = "根据条件查询查询售后服务数量")
    ...
    @ApiLogPrint(value = "根据条件查询售后服务列表")
    ...
    @ApiLogPrint(value = "根据条件分页查询售后服务")
    ...
    @ApiLogPrint(value = "根据id查询单个售后服务")
    ...
    @ApiLogPrint(value = "根据条件查询单个售后服务")
    ...
    @ApiLogPrint(value = "根据ids批量修改售后服务")
    ...
    @ApiLogPrint(value = "根据ids批量删除售后服务")
    ...
    @ApiLogPrint(value = "根据条件批量删除售后服务")
