...
import com.cafe.user.model.entity.UserPlatform;
...
public class UserPlatformController {
    ...
    @ApiLogPrint(value = "查询用户-平台关联关系数量")
    ...
    @ApiLogPrint(value = "根据条件查询查询用户-平台关联关系数量")
    ...
    @ApiLogPrint(value = "查询用户-平台关联关系列表")
    ...
    @ApiLogPrint(value = "根据条件查询用户-平台关联关系列表")
    ...
    @ApiLogPrint(value = "分页查询用户-平台关联关系列表")
    ...
    @ApiLogPrint(value = "根据id查询单个用户-平台关联关系")
    ...
    @ApiLogPrint(value = "根据条件查询单个用户-平台关联关系")
    ...
    @ApiLogPrint(value = "批量新增用户-平台关联关系")
    ...
    @ApiLogPrint(value = "根据id修改用户-平台关联关系")
    ...
    @ApiLogPrint(value = "根据ids批量修改用户-平台关联关系")
    ...
    @ApiLogPrint(value = "根据id删除用户-平台关联关系")
    ...
    @ApiLogPrint(value = "根据ids批量删除用户-平台关联关系")
    ...
    @ApiLogPrint(value = "根据条件批量删除用户-平台关联关系")
