...
public class ResourceController {
    ...
    public ResponseEntity<List<Tree>> menuTreeList(
        @ModelAttribute(value = RequestConstant.ModelAttribute.PAYLOAD_DETAILS) PayloadDetails payloadDetails
    ) {
        List<Tree> menuTreeList = resourceService.menuTreeList(payloadDetails.getAuthorities());
