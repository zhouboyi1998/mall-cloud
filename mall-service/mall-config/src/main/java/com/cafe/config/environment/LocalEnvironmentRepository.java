...
@Repository
@ConditionalOnProperty(name = "configuration-center.repository", havingValue = "LOCAL")
public class LocalEnvironmentRepository extends AbstractEnvironmentRepository {
