...
import com.cafe.captcha.config.SimpleCaptchaConfig;
 ...
 * @Description:
 */
public class SimpleCaptchaServiceImplTest {

    @InjectMocks
    private SimpleCaptchaServiceImpl captchaService;
    ...
    private final SimpleCaptchaConfig simpleCaptchaConfig = new SimpleCaptchaConfig();

    private final BackgroundProducer backgroundProducer = simpleCaptchaConfig.backgroundProducer();

    private final TextProducer textProducer = simpleCaptchaConfig.textProducer();

    private final WordRenderer wordRenderer = simpleCaptchaConfig.wordRenderer();
    ...
    void setUp() {
        ...
        // 初始化被测试的服务
        captchaService = new SimpleCaptchaServiceImpl(backgroundProducer, textProducer, wordRenderer, idFeign);
