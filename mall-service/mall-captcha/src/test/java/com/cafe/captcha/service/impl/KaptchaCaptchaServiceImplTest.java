 ...
 * @Description:
 */
public class KaptchaCaptchaServiceImplTest {

    @InjectMocks
    private KaptchaCaptchaServiceImpl captchaService;
    ...
    void setUp() {
        ...
        // 初始化被测试的服务
        captchaService = new KaptchaCaptchaServiceImpl(producer, idFeign);
