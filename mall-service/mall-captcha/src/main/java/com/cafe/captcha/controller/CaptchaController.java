...
public class CaptchaController {
    ...
    public ResponseEntity<Captcha> one(@RequestParam(value = "generator", required = false, defaultValue = StringConstant.EMPTY) String generator) {
        Captcha one = captchaServiceStrategy.captchaService(generator).one();
