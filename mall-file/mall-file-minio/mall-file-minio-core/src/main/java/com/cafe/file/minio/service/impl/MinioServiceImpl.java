...
public class MinioServiceImpl implements MinioService {
    ...
    public void download(String bucket, String fileName, HttpServletResponse httpResponse) {
        try {
            ...
            LOGGER.error("MinioServiceImpl.download() failed to download file: {}", e.getMessage());
        }
    }
    ...
    public String getFileUrl(String bucket, String fileName) {
        try {
            ...
            LOGGER.error("MinioServiceImpl.getUrl() failed to get file url: {}", e.getMessage());
            return e.getMessage();
        }
    }

    @Override
    public String getFileUrl(String bucket, String fileName, Integer expiry) {
        try {
            // 构造参数
            GetPresignedObjectUrlArgs args = GetPresignedObjectUrlArgs
                .builder()
